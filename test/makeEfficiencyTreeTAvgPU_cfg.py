...
if options.isTAvg:
    ...
    process.isoTauEfficiency = cms.EDAnalyzer(
        ...
        l1GSrc = cms.VInputTag(cms.InputTag("UCT2015EfficiencyProducer", "IsolatedTauUnpacked")),
        l1GPUSrc = cms.InputTag("UCT2015EfficiencyProducer", "PULevel"),
    ...
    process.rlxTauEfficiency = cms.EDAnalyzer(
        ...
        recoSrc = cms.VInputTag("recoTaus"),
        l1Src = cms.VInputTag(cms.InputTag("l1extraParticles", "Tau")),
        l1GSrc = cms.VInputTag(cms.InputTag("UCT2015EfficiencyProducer", "RelaxedTauUnpacked")),
        l1GPUSrc = cms.InputTag("UCT2015EfficiencyProducer", "PULevel"),
        # Max DR for RECO-trigger matching
        maxDR = cms.double(0.5),
        # Ntuple configuration
    ...
    process.isoEGEfficiency = cms.EDAnalyzer(
        ...
        l1GSrc = cms.VInputTag(cms.InputTag("UCT2015EfficiencyProducer", "IsolatedEGUnpacked")),
        l1GPUSrc = cms.InputTag("UCT2015EfficiencyProducer", "PULevel"),
        # Max DR for RECO-trigger matching
        maxDR = cms.double(0.5),
        # Ntuple configuration
    ...
    process.rlxEGEfficiency = cms.EDAnalyzer(
        ...
        l1GSrc = cms.VInputTag(cms.InputTag("UCT2015EfficiencyProducer", "RelaxedEGUnpacked")),
        l1GPUSrc = cms.InputTag("UCT2015EfficiencyProducer", "PULevel"),
        # Max DR for RECO-trigger matching
        maxDR = cms.double(0.5),
        # Ntuple configuration
...
if options.isTAvg:
    process.jetEfficiency = cms.EDAnalyzer(
        ...
        l1GSrc = cms.VInputTag(cms.InputTag("UCT2015EfficiencyProducer", "JetUnpacked")),
        l1GPUSrc = cms.InputTag("UCT2015Producer", "PULevel"),
        # Max DR for RECO-trigger matching
        maxDR = cms.double(0.5),
        # Ntuple configuration
