...
# Set useful defaults
options.inputFiles = $inputFileNames#'/store/data/Run2012C/ZeroBias1/RAW/v1/000/198/609/04F0C0E3-72CA-E111-A802-003048F117EC.root'
...
options.outputFile = "$outputFileName"#"tAvgPU_rate_tree.root"
options.maxEvents=-1
options.register(
